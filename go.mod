...
require (
	...
	k8s.io/component-helpers v0.20.5 // indirect
	k8s.io/controller-manager v0.20.5 // indirect
	k8s.io/csi-translation-lib v0.20.5 // indirect
	k8s.io/kube-openapi v0.0.0-20201113171705-d219536bb9fd // indirect
	k8s.io/mount-utils v0.21.0-beta.0 // indirect
	sigs.k8s.io/apiserver-network-proxy/konnectivity-client v0.0.15 // indirect
	sigs.k8s.io/structured-merge-diff/v4 v4.1.2 // indirect
)

replace (
	github.com/alibaba/open-local => github.com/alibaba/open-local v0.5.6-0.20220907055526-c5da56ff9be3
